...
@section('card')
        ...
        <div class="container-fluid  card bg-secondary shadow mt-3" id="meat-create-form">
          ...
          <div class="row">
            ...
            <form class="meat-create-form" method="post" enctype="multiple/form-data">
              <input type="hidden" name="category_id" value="1">
              <input type="hidden" name="folderName" value="meat">
               <div class="col-md-12">
        ...
        <div class="container-fluid d-none card bg-secondary shadow mt-3" id='meat-edit-form'>
          <div class="alert alert-success d-none">
                <span class="message"></span>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
          ...
          <div class="row">
            ...
            <div class="col-md-6" >
               ...
               <input type="hidden" name="category_id" value="1">
              <input type="hidden" name="folderName" value="meat">
            <form class="meat-edit-form" method="post" enctype="multiple/form-data">
               <div class="col-md-12">
                  <label class="form-control-label" for="customFileLang">
                          Photo
                        </label>
        ...
        <div class="container-fluid  card bg-secondary p-2 shadow mt-3">
            <h1 class="text-center">The list of Meat </h1>
  ...
  $(document).ready(function(){
   ...
   toastr.options.closeButton = true;
    ...
    $('#meat').on('click','.btn-edit',function(){
      ...
      $('#meat-create-form').addClass('d-none');
      $('#meat-edit-form').removeClass('d-none');
      var id=$(this).data('id');
     ...
     $.get(url,function(response){
      ...
      var img=`{{asset('${response.photo}')}}`
      $('.old-preview').attr('src',img);
     })
    ...
    //update start here
    $('.meat-edit-form').submit(function(e){
      e.preventDefault();
      // alert('hloe');
      ...
      formdata.append('_method','PUT');
        ...
        $.ajax({
          ...
          $('#meat-create-form').removeClass('d-none');
          $('#meat-edit-form').addClass('d-none');
         showTable();
    ...
    $('.meat-create-form').submit(function(e){
    	e.preventDefault();
